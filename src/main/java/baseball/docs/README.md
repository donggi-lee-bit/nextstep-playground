...
- 위 숫자 야구 게임에서 상대방의 역할을 컴퓨터가 한다. 컴퓨터는 1에서 9까지 서로 다른 임의의 수 3개를 선택한다. 게임 플레이어는 컴퓨터가 생각하고 있는 3개의 숫자를 입력하고, 컴퓨터는 입력한 숫자에 대한 결과를 출력
...
- [ ] 상대방(컴퓨터)은 서로 다른 임의의 수 3개를 생성한다
- [ ] 플레이어는 3개의 숫자를 입력한다
  - [ ] 숫자는 서로 다른 수를 입력해야한다 
- [ ] 입력 값에 따라 힌트를 출력한다
  - [ ] 같은 수가 같은 자리에 있으면 스트라이크
  - [ ] 같은 수가 다른 자리에 있으면 볼
  - [ ] 같은 수가 전혀 없으면 포볼 혹은 낫싱
